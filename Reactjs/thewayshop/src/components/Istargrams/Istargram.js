...
export default class Istargram extends Component {
    render() {
        return (
            <div className="instagram-box">
                <div className="main-instagram owl-carousel owl-theme owl-loaded owl-drag">
                    ...
                    </div></div></div></div><div className="owl-nav"><button type="button" role="presentation" className="owl-prev"><i className="fas fa-arrow-left" /></button><button type="button" role="presentation" className="owl-next"><i className="fas fa-arrow-right" /></button></div><div className="owl-dots disabled" /></div>
            </div>
        )
    }
}
